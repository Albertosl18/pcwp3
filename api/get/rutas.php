...
//   api/rutas?td={tiempo desde}&th={tiempo hasta} -> búsqueda por tiempo de ruta, desde-hasta. Se puede utilizar solo uno de los dos parámetros. Para indicar el orden, se puede añadir el parámetro ot con el valor 'asc' o 'desc', para orden ascendente o descendente, respectivamente. Por ejemplo: api/rutas?td=2.5&th=6&ot=asc
